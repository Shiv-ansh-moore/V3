-- ============================================================================
-- get_group_recent_proofs: include the goal creation time so clients can mark
-- late proofs without extra per-proof goal lookups.
-- ============================================================================
drop function if exists public.get_group_recent_proofs (uuid);

create function public.get_group_recent_proofs (p_group_id uuid) returns table (
  proof_id uuid,
  user_id uuid,
  message_id uuid,
  goal_id uuid,
